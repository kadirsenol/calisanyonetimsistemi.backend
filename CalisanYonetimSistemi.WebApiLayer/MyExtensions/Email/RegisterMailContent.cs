...
{
    public class RegisterMailContent
    {
        public async Task<string> AddMailContent(int withiduserid, string code, string username)
        {
            StringBuilder MailContent = new StringBuilder();
            MailContent.AppendLine($@"<!DOCTYPE html>
<head>
    <meta charset='utf-8'>
            ...
            <table align='center' role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'
                        ...
                        <table role='presentation' border='0' cellpadding='0' cellspacing='0' width='100%'>
                            <tr>
                                <td class='logo' style='text-align: center;'>
                                    <h1><a href='#'>INITY SOFTWARE</a></h1>
                                    <h1><a style='font-style: italic;'>Digitalizes your life</a></h1>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td valign='middle' class='hero bg_white' style='padding: 3em 0 2em 0;'>
                        <img src='https://static.vecteezy.com/system/resources/previews/026/703/098/non_2x/illustration-of-brain-technology-icon-in-dark-color-and-white-background-vector.jpg'
                            alt=''
                            style='width: 300px; max-width: 600px; height: auto; margin: auto; display: block; margin-top: -56px;'>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td>
                                    <div class='text' style='padding: 0 2.5em; text-align: center; margin-top: -110px;'>
                                       ...
                                       <a href='http://localhost:5237/api/Account/ConfirmEmail?uid={withiduserid}&code={code}' style='display: inline-block; padding: 10px 15px; border-radius: 5px; background: #333635; color: #ffffff; text-decoration: none;'>Yes! Subscribe Me</a>
            ...
            <table align='center' role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'
                                    ...
                                    <table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'>
                                        <tr>
                                            <td style='text-align: left; padding-left: 5px; padding-right: 5px;'>
                                                ...
                                                <ul>
                                                    <li><span class='text'>İstanbul</span></li>
                                                    <li><span class='text'>0552 364 2361</span></a></li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td class='bg_light' style='text-align: center;'>
                        <p>It is not for commercial purposes. !</p>
                    </td>
                </tr>
            </table>
        </div>
